classdef apm_probDvhMinQuantileConstraint
    ...
    methods
        function obj = apm_probDvhMinQuantileConstraint(dParam,minVolume,probability,dist)           
            obj.dParam = dParam; 
            obj.minV = minVolume;
        ...
        function covGrad = gradientCovDose(obj,expDose,covDose)
            ...
            switch obj.dist
                case 'normal'
                    ...
                    squaredExpGrad = 2 * dvExp * varGrad;
